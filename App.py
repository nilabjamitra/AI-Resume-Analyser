...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Nilabja12#',db='cv')
...
def run():
    ...
    link = '<b>Built with <a href="#" style="text-decoration: none; color: #021659;">ALPHA-Q</a></b>' 
    ...
    ###### CODE FOR FEEDBACK SIDE ######
        ...
        with st.form("my_form"):
            ...
            if submitted:
                ...
                ## Success Message 
                st.success("Your Feedback was recorded.") 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built  by 
            <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">AlphaQ</a> through 
            <a href="https://www.linkedin.com/in/mrbriit/" style="text-decoration: none; color: grey;">Team</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Team AlphaQ ! Total %d " % values + " User's Have Used Our Tool : )")                
